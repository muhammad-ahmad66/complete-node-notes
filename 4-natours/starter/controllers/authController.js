...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // GRANT ACCESS TO TO PROTECTED ROUTE
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 3) Update changedPasswordAt property of the current user(Implemented in userModel.js)
  // 4) Log the user in. Send the jwt to the user.
  createSendToken(user, 200, res);
});

// Update a password, without forget, only for logged in user.
