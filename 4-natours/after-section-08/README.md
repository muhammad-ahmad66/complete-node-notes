...
Actually one very nice trick is that the message property also has access to the value. VALUE inside curly braces. *message: 'Discount price ({VALUE}) should be below regular price'*
